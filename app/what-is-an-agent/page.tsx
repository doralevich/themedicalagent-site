...
const COMPARISON = [
  ...
  },
  {
    ...
    agent: "It connects to where your practice already works and produces the draft, the packet or the summary itself.",
  },
  {
    chatbot: "It is the same product for everyone.",
    agent: "It is configured around your specialty, your standing instructions, and your clinical line.",
  },
  {
    ...
    <>
      ...
      <main>
        ...
        <ClosingCta
          ...
          body="Build your agent online in about fifteen minutes, or book a consultation and we will walk through exactly what it would do for your practice."
        />
      </main>
      <Footer />
    </>
