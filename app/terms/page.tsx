...
//
// The no-advice section carries more weight on THIS site than on most of the others.
// Everywhere else an over-read means mistaking marketing for a guarantee. Here it means somebody
// treating an administrative tool as a clinical one, and the person who gets hurt is a patient
// rather than a customer. So it says the two things that matter plainly and early: this does not
// practise medicine, and it is not a medical device. It mirrors the boundary the product itself
// enforces - the agent type in apolloclaw2 defines this one as administrative support only, not
// diagnosis.
//
...
const SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        kind: "prose",
        text: "Nothing on this site is medical advice. Apollo Claw is not a healthcare provider, we do not practise medicine, and nothing here creates a clinician-patient relationship with anyone. Nothing on this site is intended to diagnose, treat, cure or prevent any condition.",
      },
      {
        kind: "prose",
        text: "The agent itself is administrative software. It is not a clinician and it is not a medical device. It drafts correspondence, assembles paperwork, organizes records and summarizes literature. It does not diagnose, it does not recommend treatment, it does not triage, and it does not make decisions about a patient. Its output is a draft for a qualified person to review, and it is configured at setup with the line beyond which a licensed clinician must always take over. Clinical judgment stays with the clinician.",
      },
    ],
  },
  {
