...
export const metadata: Metadata = pageMeta({
  ...
  description:
    "The Medical Agent is built by Apollo Claw, in-house on Long Island. Who builds it, why it exists, and how engagements are handled.",
  path: "/about",
  keywords: [
    "Apollo Claw",
    "David Oralevich",
        ...
        <section className="grid-light-section py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-ink leading-relaxed space-y-4">
              ...
              <p>
                What he saw was a gap. Practices were drowning in administrative work while AI sat
                untapped. The technology existed to take the first pass at the documents
                nobody needed a medical licence to produce. Nobody had built it for
                them, and the tools that claimed to were generic.
              </p>
              <p>
                So he built it. Apollo Claw and a portfolio of industry-specific AI agents,
                each one purpose-built for a role. The Medical Agent is built on the same
                foundation.
              </p>
              <p>
        ...
        <section className="bg-white py-20">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="text-lg text-ink leading-relaxed space-y-4">
              <p>
                The Medical Agent is one of a family of role-specific agents from Apollo
